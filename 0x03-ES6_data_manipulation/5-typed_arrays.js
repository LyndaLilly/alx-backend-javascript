/**
 * this creates a new Int8Array with the given length, sets the value at the
 * this is the specified position, and returns a DataView of the array.
 * when adding the value is not possible the error Position outside range
 * should be thrown.
 *
